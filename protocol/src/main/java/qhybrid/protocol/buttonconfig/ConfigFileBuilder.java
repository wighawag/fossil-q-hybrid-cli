...
package qhybrid.protocol.buttonconfig;
...
public class ConfigFileBuilder {
    ...
    /**
     * WP7: byte assembly now lives in the pure {@link ButtonCompiler} (single source of
     * truth). This method delegates 1:1 to
     * {@link ButtonCompiler#compileSingleEntryPerButton(ConfigPayload[], boolean)}.
     */
    public byte[] build(boolean appendChecksum) {
        return ButtonCompiler.compileSingleEntryPerButton(this.configs, appendChecksum);
    }
}
